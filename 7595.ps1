...
# =========================================================
#  YOUTUBE TV INSTALLER v75.9.5 (SILENT SWAP)
#  Version: 2.0 Build 23.75.9.5
#  File: 7595.ps1 | Branch: branch
#  Status: No Console Spam on Lang Swap | DarkBlue Console
# =========================================================

# ---------------------------------------------------------
# [1] CONFIG & LANGUAGE
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.9.5"
...
if (!$Silent) {
    ...
    $host.UI.RawUI.BackgroundColor = "DarkBlue"; # [FIX] Blue Background
...
if(!$Silent){ Write-Host "`n==========================================" -ForegroundColor Green; Write-Host "   (V.2 Build 23.75.9.5 : $BuildDate)     " -ForegroundColor Green; Write-Host "==========================================" -ForegroundColor Green; Write-Host " [INIT] Scanning installed browsers..." -ForegroundColor Green }
...
"@
    ...
    function Render-BrowserList {
        ...
        foreach ($b in $Global:Browsers) {
            ...
            if ($b.IsFound) { 
                # [SILENT SWAP] Console log removed for cleaner UX
            } 

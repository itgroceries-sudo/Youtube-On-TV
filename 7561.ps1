...
# =========================================================
#  YOUTUBE TV INSTALLER v75.6.1 (STACKED FOOTER)
#  Version: 2.0 Build 23.75.6.1
#  File: 7561.ps1 | Branch: branch
#  Status: Socials above Options (Bottom Left)
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION & ARGUMENTS
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.6.1"
...
$BaseW = 580; $BaseH = 880 # Expanded Height for Stacked Footer
...
if(!$Silent){ 
    ...
    Write-Host "   (V.2 Build 23.75.6.1 : $BuildDate)     " -ForegroundColor Green

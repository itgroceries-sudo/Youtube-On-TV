...
# =========================================================
#  YOUTUBE TV INSTALLER v87.0 (BUTTON & LAYOUT RESTORED)
#  Status: All-in-One UI | Buttons Fixed | Perfect Width
# =========================================================
...
$SelfURL = "$GitHubRaw/87.ps1"
$AppVersion = "2.0 Build 31.87"
$BuildDate  = "31-1-2026"
...
foreach($k in $Assets.Keys){ $D="$InstallDir\$k.ico"; if(!(Test-Path $D)){ try{(New-Object Net.WebClient).DownloadFile($Assets[$k],$D)}catch{} } }
...
Title="YouTube TV Installer" Height="880" Width="520" WindowStartupLocation="CenterScreen" ResizeMode="NoResize" Background="#181818" Topmost="True" WindowStyle="None" BorderBrush="#2196F3" BorderThickness="2">
    ...
    <Grid Margin="25,20,25,25">
        <Grid.RowDefinitions>
            <RowDefinition Height="Auto"/> <RowDefinition Height="15"/>   <RowDefinition Height="*"/>    <RowDefinition Height="110"/>  <RowDefinition Height="Auto"/> </Grid.RowDefinitions>
        ...
        <Grid Grid.Row="0">
            ...
            <Button x:Name="BAbt" Grid.Column="2" HorizontalAlignment="Right" VerticalAlignment="Top" Width="30" Height="30" Background="Transparent" BorderThickness="0" Cursor="Hand" ToolTip="About">
                <Viewbox Width="20" Height="20"><Path Fill="#AAAAAA" Data="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z"/></Viewbox>
            </Button>
        </Grid>

        <Border Grid.Row="2" Background="#1E1E1E" CornerRadius="5">
            <ScrollViewer VerticalScrollBarVisibility="Auto">
                <StackPanel x:Name="List" Margin="10,5,10,5"/>
            </ScrollViewer>
        </Border>
        
        <Border Grid.Row="3" Background="#000000" CornerRadius="8" Margin="0,15,0,0" BorderBrush="#333333" BorderThickness="1">
            <ScrollViewer x:Name="LogScroll" VerticalScrollBarVisibility="Auto">
                <TextBlock x:Name="LogBox" Foreground="#00FF00" FontFamily="Consolas" FontSize="11" Margin="10" TextWrapping="Wrap" Text="[SYSTEM] Buttons Repaired. Standby."/>
            </ScrollViewer>
        </Border>
...
# Fix Social & About Buttons Actions

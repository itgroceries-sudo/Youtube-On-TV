...
# =========================================================
#  YOUTUBE TV INSTALLER v75.7.0 (MODE & LABELS)
#  Version: 2.0 Build 23.75.7.0
#  File: 7570.ps1 | Branch: branch
#  Status: TV/PC Dropdown | Icon Labels | Centering Fix
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.7.0"
...
$BaseW = 620; $BaseH = 880; # Increased width slightly for labels
...
if(!$Silent){ Write-Host "`n==========================================" -ForegroundColor Green; Write-Host "   (V.2 Build 23.75.7.0 : $BuildDate)     " -ForegroundColor Green; Write-Host "==========================================" -ForegroundColor Green; Write-Host " [INIT] Scanning installed browsers..." -ForegroundColor Green }
...
function Install-Browser {
    ...
    # [LOGIC] Check PC Mode vs TV Mode
    $SmartUA = "Mozilla/5.0 (SMART-TV; LINUX; Tizen 5.5) AppleWebKit/537.36 (KHTML, like Gecko) 69.0.3497.106/5.5 TV Safari/537.36"
    $ArgList = "/c taskkill /f /im $($Obj.E) /t >nul 2>&1 & start `"`" `"$($Obj.Path)`" --profile-directory=Default --app=https://youtube.com/tv"
    
    # If TV Mode (Not PC), add User-Agent. If PC, standard UA is used.
    if (-not $IsPCMode) { $ArgList += " --user-agent=`"$SmartUA`"" }
    
    # Common Flags
    $ArgList += " --start-fullscreen --disable-features=CalculateNativeWinOcclusion --disable-renderer-backgrounding --disable-background-timer-throttling"
...
Title="YouTube TV Installer" Height="$BaseH" Width="$BaseW" WindowStartupLocation="Manual" ResizeMode="NoResize" Background="#181818" Topmost="True" WindowStyle="None" BorderBrush="#2196F3" BorderThickness="4">
    <Window.Resources>
        ...
        <Style x:Key="LabeledBtn" TargetType="Button">
            ...
            <Setter Property="Template"><Setter.Value><ControlTemplate TargetType="Button">
                <Border x:Name="b" Background="{TemplateBinding Background}" CornerRadius="5" Padding="10,0,10,0">
        ...
        <Style TargetType="{x:Type ComboBox}">
            <Setter Property="Template"><Setter.Value><ControlTemplate TargetType="ComboBox">
                <Grid><ToggleButton Name="ToggleButton" Template="{DynamicResource ComboBoxToggleButton}" Grid.Column="2" Focusable="false" IsChecked="{Binding Path=IsDropDownOpen,Mode=TwoWay,RelativeSource={RelativeSource TemplatedParent}}" ClickMode="Press"/>
                ...
                <Popup Name="Popup" Placement="Bottom" IsOpen="{TemplateBinding IsDropDownOpen}" AllowsTransparency="True" Focusable="False" PopupAnimation="Slide">
                    <Grid Name="DropDown" SnapsToDevicePixels="True" MinWidth="{TemplateBinding ActualWidth}" MaxHeight="{TemplateBinding MaxDropDownHeight}"><Border x:Name="DropDownBorder" Background="#333333" BorderThickness="1" BorderBrush="#2196F3"/><ScrollViewer Margin="4,6,4,6" SnapsToDevicePixels="True"><StackPanel IsItemsHost="True" KeyboardNavigation.DirectionalNavigation="Contained" /></ScrollViewer></Grid>
                </Popup></Grid>
            </ControlTemplate></Setter.Value></Setter>
        </Style>
        <ControlTemplate x:Key="ComboBoxToggleButton" TargetType="ToggleButton">
            <Border x:Name="Border" Grid.ColumnSpan="2" CornerRadius="5" Background="#333333" BorderBrush="#2196F3" BorderThickness="1">
                <Path x:Name="Arrow" Grid.Column="1" Fill="#2196F3" HorizontalAlignment="Right" VerticalAlignment="Center" Margin="0,0,8,0" Data="M 0 0 L 4 4 L 8 0 Z"/>
            </Border>
        </ControlTemplate>
    </Window.Resources>
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="0">
            ...
            <ComboBox x:Name="ComboMode" Grid.Column="2" Width="130" Height="30" VerticalAlignment="Top" HorizontalAlignment="Right" Margin="0,10,0,0" Foreground="White" FontSize="14" FontWeight="Bold" Cursor="Hand">
        ...
        <StackPanel Grid.Row="3" Orientation="Horizontal" Margin="0,15,0,8">
             <Button x:Name="BF" Style="{StaticResource LabeledBtn}" ToolTip="Visit Facebook">
                <StackPanel Orientation="Horizontal">
                    <TextBlock Text="f" Foreground="#1877F2" FontSize="20" FontWeight="Bold" Margin="0,0,5,0" VerticalAlignment="Center"/>
        ...
        <Grid Grid.Row="4">
            ...
            <StackPanel Orientation="Horizontal" Grid.Column="0">
                <Button x:Name="BDesk" Style="{StaticResource LabeledBtn}" ToolTip="Toggle Desktop Shortcut" Tag="On" Background="#0078D7">
                    <StackPanel Orientation="Horizontal">
                        <Viewbox Width="16" Height="16" Margin="0,0,5,0"><Path Fill="White" Data="M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z"/></Viewbox>
                ...
                <Button x:Name="BWin" Style="{StaticResource LabeledBtn}" ToolTip="Toggle Start Menu Shortcut" Tag="Off">
                    <StackPanel Orientation="Horizontal">
                        <Viewbox Width="16" Height="16" Margin="0,0,5,0"><Path Fill="White" Data="M0 0h11.377v11.372H0V0zm12.623 0H24v11.372H12.623V0zM0 12.623h11.377V24H0V12.623zm12.623 0H24V24H12.623V12.623z"/></Viewbox>
                ...
                <Button x:Name="BTrash" Style="{StaticResource LabeledBtn}" ToolTip="Toggle Uninstall Mode" Tag="Off">
                    <StackPanel Orientation="Horizontal">
                        <Viewbox Width="14" Height="14" Margin="0,0,5,0"><Path Fill="White" Data="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></Viewbox>
            ...
            <StackPanel Orientation="Horizontal" Grid.Column="2" HorizontalAlignment="Right">
                <Button x:Name="BA" Content="Start Install" Width="140" Height="35" Background="#2E7D32" Foreground="White" Style="{StaticResource Btn}" Margin="0,0,10,0" Cursor="Hand"/>
                <Button x:Name="BC" Content="EXIT" Width="90" Height="35" Background="#D32F2F" Foreground="White" Style="{StaticResource Btn}" Cursor="Hand"/>
            </StackPanel>
        </Grid>
    </Grid>
</Window>

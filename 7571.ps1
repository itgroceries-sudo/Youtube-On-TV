...
# =========================================================
#  YOUTUBE TV INSTALLER v75.7.1 (PERFECTIONIST)
#  Version: 2.0 Build 23.75.7.1
#  File: 7571.ps1 | Branch: branch
#  Status: Launcher Console | PC Mode Fix | Balanced UI
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.7.1"
...
# ---------------------------------------------------------
# Only show this screen if NOT silent and NOT yet Admin
...
if (-not $Silent -and -not $IsAdmin) {
    ...
    # Draw Interface (Based on Image)
    Write-Host "`n================================================================================" -ForegroundColor DarkGray
    Write-Host "              Y o u t u b e On TV I n s t a l l e r                    " -ForegroundColor Cyan -BackgroundColor DarkBlue
...
if(!$Silent){ Write-Host "`n==========================================" -ForegroundColor Green; Write-Host "   (V.2 Build 23.75.7.1 : $BuildDate)     " -ForegroundColor Green; Write-Host "==========================================" -ForegroundColor Green; Write-Host " [INIT] Scanning installed browsers..." -ForegroundColor Green }
...
function Install-Browser {
    ...
    # If TV Mode (Default), Add Tizen UA. If PC Mode, Skip UA (Standard).
        ...
        <Style x:Key="LabeledBtn" TargetType="Button">
            ...
            <Setter Property="Template"><Setter.Value><ControlTemplate TargetType="Button">
                <Border x:Name="b" Background="{TemplateBinding Background}" CornerRadius="5" Padding="15,0,15,0">
                    <ContentPresenter HorizontalAlignment="Center" VerticalAlignment="Center" TextElement.FontWeight="Bold" TextElement.FontSize="14"/>
                </Border>
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="4">
            ...
            <StackPanel Orientation="Horizontal" Grid.Column="2" HorizontalAlignment="Right">
                <Button x:Name="BA" Content="Start Install" Width="140" Height="40" Background="#2E7D32" Foreground="White" Style="{StaticResource Btn}" Margin="0,0,10,0" Cursor="Hand"/>
...
function Load-BrowserList {
    ...
    $RefTxt = New-Object System.Windows.Controls.TextBlock; $RefTxt.Text = "Installed a new browser? Click Refresh"; $RefTxt.Foreground="#4CAF50"; $RefTxt.FontSize=13; $RefTxt.FontWeight="Bold"; $RefTxt.VerticalAlignment="Center"

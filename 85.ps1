...
# =========================================================
#  YOUTUBE TV INSTALLER v85.0 (TRUE SINGLE WINDOW)
#  Status: ZERO Console | Stealth Admin | All-in-One UI
# =========================================================
...
$SelfURL = "$GitHubRaw/85.ps1"
$AppVersion = "2.0 Build 29.85"
$BuildDate  = "30-1-2026"
...
if (-not $Silent -and -not $Principal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    # [FIX] Force "Hidden" WindowStyle when elevating to hide that blue/black console
    if (!$IsLocal) {
        ...
        # Hybrid Batch elevation usually shows a flash, but we suppress it as much as possible
...
Title="YouTube TV Installer" Height="820" Width="500" WindowStartupLocation="CenterScreen" ResizeMode="NoResize" Background="#181818" Topmost="True" WindowStyle="None" BorderBrush="#2196F3" BorderThickness="2">
    <Window.Resources>
    ...
    <Grid Margin="25">
        ...
        <Border Grid.Row="3" Background="#000000" CornerRadius="8" Margin="0,15,0,0" BorderBrush="#333333" BorderThickness="1">
            <ScrollViewer x:Name="LogScroll" VerticalScrollBarVisibility="Auto">
                <TextBlock x:Name="LogBox" Foreground="#00FF00" FontFamily="Consolas" FontSize="11" Margin="10" TextWrapping="Wrap" Text="[SYSTEM] Stealth Mode Active..."/>
            </ScrollViewer>
        </Border>
...
$Window.FindName("BA").Add_Click({
    ...
    Write-Log "[START] Installing shortcuts..."
    foreach ($i in $Sel) {
        ...
        if($FP){
            ...
            $Sut = Join-Path $Desktop "YouTube On TV - $($Obj.N).lnk"
    ...
    Write-Log "[FINISH] All tasks done."
})

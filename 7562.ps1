...
# =========================================================
#  YOUTUBE TV INSTALLER v75.6.2 (CARD UI)
#  Version: 2.0 Build 23.75.6.2
#  File: 7562.ps1 | Branch: branch
#  Status: Browsers as Cards | Refresh in List | Header Controls
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION & ARGUMENTS
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.6.2"
...
if (-not $Silent -and -not $Principal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    Clear-Host
    Write-Host "`n [SYSTEM] Requesting Admin Privileges..." -ForegroundColor Yellow
    ...
    try {
        if ($TargetFile -and (Test-Path $TargetFile)) {
            ...
            Write-Host " [INFO] Downloading temp script..." -ForegroundColor Cyan
        ...
        Write-Host "`n [ERROR] Failed to start Admin process: $_" -ForegroundColor Red
...
if(!$Silent){ 
    ...
    Write-Host "   (V.2 Build 23.75.6.2 : $BuildDate)     " -ForegroundColor Green
...
function Play-Sound($Type) {
    try {
        switch ($Type) {
            "Click" { [System.Media.SystemSounds]::Beep.Play() }
            "Tick"  { [System.Console]::Beep(2000, 20) }
            "Warn"  { [System.Media.SystemSounds]::Hand.Play() }
...
function Install-Browser {
    param($NameKey, $Uninstall=$false, $UseStartMenu=$false) 
    ...
    foreach ($TargetDir in $Targets) {
        ...
        $Sut = Join-Path $TargetDir $LnkName
...
Title="YouTube TV Installer" Height="$BaseH" Width="$BaseW" WindowStartupLocation="Manual" ResizeMode="NoResize" Background="#181818" Topmost="True" WindowStyle="None" BorderBrush="#2196F3" BorderThickness="4">
    <Window.Resources>
        <Style x:Key="BlueSwitch" TargetType="{x:Type CheckBox}">
            <Setter Property="Template"><Setter.Value><ControlTemplate TargetType="{x:Type CheckBox}">
                <Border x:Name="T" Width="44" Height="24" Background="#3E3E3E" CornerRadius="22" Cursor="Hand"><Border x:Name="D" Width="20" Height="20" Background="White" CornerRadius="20" HorizontalAlignment="Left" Margin="2,0,0,0"><Border.RenderTransform><TranslateTransform x:Name="Tr" X="0"/></Border.RenderTransform></Border></Border>
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="0">
            ...
            <StackPanel Grid.Column="2" Orientation="Horizontal" VerticalAlignment="Top" HorizontalAlignment="Right" Margin="0,5,0,0">
                 <Button x:Name="BF" Style="{StaticResource HeaderBtn}" Margin="0,0,5,0" ToolTip="Facebook"><TextBlock Text="f" Foreground="#1877F2" FontSize="20" FontWeight="Bold"/></Button>
                 <Button x:Name="BG" Style="{StaticResource HeaderBtn}" Margin="0,0,5,0" ToolTip="GitHub"><Viewbox Width="20" Height="20"><Path Fill="#AAAAAA" Data="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></Viewbox></Button>
                 <Button x:Name="BAbt" Style="{StaticResource HeaderBtn}" ToolTip="About"><Viewbox Width="20" Height="20"><Path Fill="#607D8B" Data="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z"/></Viewbox></Button>
            </StackPanel>
        </Grid>
        ...
        <Grid Grid.Row="4" Margin="0,20,0,0">
            ...
            <StackPanel Orientation="Horizontal" Grid.Column="0">
                <Button x:Name="BWin" Style="{StaticResource VectorBtn}" Margin="0,0,8,0" ToolTip="Add to Start Menu" Cursor="Hand" Tag="Off"><Viewbox Width="24" Height="24"><Path Fill="White" Data="M0 0h11.377v11.372H0V0zm12.623 0H24v11.372H12.623V0zM0 12.623h11.377V24H0V12.623zm12.623 0H24V24H12.623V12.623z"/></Viewbox></Button>
                <Button x:Name="BTrash" Style="{StaticResource VectorBtn}" Margin="0,0,8,0" ToolTip="Uninstall Mode" Cursor="Hand" Tag="Off"><Viewbox Width="20" Height="20"><Path Fill="White" Data="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></Viewbox></Button>
            </StackPanel>
            
            <StackPanel Orientation="Horizontal" Grid.Column="2" HorizontalAlignment="Right">
                <Button x:Name="BA" Content="Start Install" Width="140" Height="45" Background="#2E7D32" Foreground="White" Style="{StaticResource Btn}" Margin="0,0,10,0" Cursor="Hand"/>
                <Button x:Name="BC" Content="EXIT" Width="90" Height="45" Background="#D32F2F" Foreground="White" Style="{StaticResource Btn}" Cursor="Hand"/>
            </StackPanel>
        </Grid>
    </Grid>
</Window>
...
$BWin = $Window.FindName("BWin"); $BTrash = $Window.FindName("BTrash")

# --- Refresh Function (With Card UI) ---
function Load-BrowserList {
    ...
    foreach ($b in $Global:Browsers) {
        ...
        $Bor.Add_MouseLeftButtonUp({
            ...
            if ($cb.IsEnabled) { $cb.IsChecked = -not $cb.IsChecked } else { if ($sender.Tag) { Start-Process $sender.Tag } }
        })
    }

    # 2. Add Refresh Card (At the bottom)
    $RefRow = New-Object System.Windows.Controls.Grid; $RefRow.Height = 45; $RefRow.Margin = "0,2,0,2"
    $RefRow.ColumnDefinitions.Add((New-Object System.Windows.Controls.ColumnDefinition -Property @{Width=[System.Windows.GridLength]::Auto}))
    $RefRow.ColumnDefinitions.Add((New-Object System.Windows.Controls.ColumnDefinition -Property @{Width=[System.Windows.GridLength]::new(1, [System.Windows.GridUnitType]::Star)}))
    
    $RefBor = New-Object System.Windows.Controls.Border; $RefBor.CornerRadius = 5; $RefBor.Background = [System.Windows.Media.BrushConverter]::new().ConvertFromString("#252526"); $RefBor.Padding = "10"; $RefBor.Child = $RefRow; $RefBor.Cursor = "Hand"
    ...
    # Refresh Icon (Using Path)
    $RefPath = New-Object System.Windows.Shapes.Path
    $RefPath.Data = [System.Windows.Media.Geometry]::Parse("M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z")
    $RefPath.Fill = [System.Windows.Media.BrushConverter]::new().ConvertFromString("#4CAF50")
    $RefView = New-Object System.Windows.Controls.Viewbox; $RefView.Width=24; $RefView.Height=24; $RefView.Child = $RefPath
    
    [System.Windows.Controls.Grid]::SetColumn($RefView,0); $RefRow.Children.Add($RefView)|Out-Null
    
    $RefTxt = New-Object System.Windows.Controls.TextBlock; $RefTxt.Text = "Installed a new browser? Click Refresh"; $RefTxt.Foreground="#4CAF50"; $RefTxt.FontSize=16; $RefTxt.FontWeight="Bold"; $RefTxt.VerticalAlignment="Center"; $RefTxt.Margin="15,0,0,0"
    [System.Windows.Controls.Grid]::SetColumn($RefTxt,1); $RefRow.Children.Add($RefTxt)|Out-Null
    
    $Stack.Children.Add($RefBor)|Out-Null
    
    $RefBor.Add_MouseLeftButtonUp({
        Play-Sound "Click"
        Load-BrowserList
    })
}
...
$BA.Add_Click({
    ...
    $IsUninstall = ($BTrash.Tag -eq "On")
    $UseStartMenu = ($BWin.Tag -eq "On")
    
    foreach ($i in $Sel) { Install-Browser $i.Child.Children[2].Tag $IsUninstall $UseStartMenu }
    
    $BA.Content = "Finished"; Play-Sound "Done"; Start-Sleep 2; $BA.IsEnabled = $true
    if ($IsUninstall) { $BA.Content = "Uninstall Selected" } else { $BA.Content = "Start Install" }
})

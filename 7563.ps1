...
# =========================================================
#  YOUTUBE TV INSTALLER v75.6.3 (FINAL UI FIX)
#  Version: 2.0 Build 23.75.6.3
#  File: 7563.ps1 | Branch: branch
#  Status: Card UI | Refresh in List | Socials above Options
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION & ARGUMENTS
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.6.3"
...
if(!$Silent){ 
    ...
    Write-Host "   (V.2 Build 23.75.6.3 : $BuildDate)     " -ForegroundColor Green
...
Title="YouTube TV Installer" Height="$BaseH" Width="$BaseW" WindowStartupLocation="Manual" ResizeMode="NoResize" Background="#181818" Topmost="True" WindowStyle="None" BorderBrush="#2196F3" BorderThickness="4">
    ...
    <Grid Margin="25">
        ...
        <StackPanel Grid.Row="3" Orientation="Horizontal" Margin="0,15,0,8">
...
# --- Refresh Function (Card UI Integrated) ---
function Load-BrowserList {
    ...
    # 2. Add Refresh Card (Bottom of List)

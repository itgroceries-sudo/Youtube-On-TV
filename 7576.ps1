...
# =========================================================
#  YOUTUBE TV INSTALLER v75.7.6 (STRUCTURE VERIFIED)
#  Version: 2.0 Build 23.75.7.6
#  File: 7576.ps1 | Branch: branch
#  Status: Fixed cmd Elevation | Confirmed All Logic
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION & LANGUAGE
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.7.6"
...
if(!$Silent){ Write-Host "`n==========================================" -ForegroundColor Green; Write-Host "   (V.2 Build 23.75.7.6 : $BuildDate)     " -ForegroundColor Green; Write-Host "==========================================" -ForegroundColor Green; Write-Host " [INIT] Scanning installed browsers..." -ForegroundColor Green }

# ---------------------------------------------------------
# [6] LOGIC
# ---------------------------------------------------------
$Desktop = [Environment]::GetFolderPath("Desktop")
# [FIX] Smart Start Menu Logic

...
#  Version: 2.0 Build 23.75.5.9
#  Status: Syntax Error Fixed | Stable Core
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION & ARGUMENTS
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.5.9"
...
if(!$Silent){ 
    ...
    Write-Host "   (V.2 Build 23.75.5.9 : $BuildDate)     " -ForegroundColor Green
...
function Install-Browser {
    ...
    # [FIXED SYNTAX] Define Targets Array clearly
    $Targets = @($Desktop)

...
# =========================================================
#  YOUTUBE TV INSTALLER v75.6.0 (UI RE-BALANCE)
#  Version: 2.0 Build 23.75.6.0
#  File: 7560.ps1 | Branch: branch
#  Status: Top Header Controls | Footer Re-ordered
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION & ARGUMENTS
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.6.0"
$BuildDate  = "04-02-2026"
$InstallDir = "$env:LOCALAPPDATA\ITG_YToTV"
# [FIXED] Temp script name as requested
$TempScript = "$env:TEMP\YToTV.ps1" 
$GitHubRaw  = "https://raw.githubusercontent.com/itgroceries-sudo/Youtube-On-TV/branch"
# [FIXED] Pointing to 7560.ps1
$SelfURL    = "$GitHubRaw/7560.ps1"
...
if(!$Silent){ 
    ...
    Write-Host "   (V.2 Build 23.75.6.0 : $BuildDate)     " -ForegroundColor Green
...
Title="YouTube TV Installer" Height="$BaseH" Width="$BaseW" WindowStartupLocation="Manual" ResizeMode="NoResize" Background="#181818" Topmost="True" WindowStyle="None" BorderBrush="#2196F3" BorderThickness="4">
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="0">
            ...
            <StackPanel Grid.Column="2" Orientation="Horizontal" VerticalAlignment="Top" Margin="0,5,0,0">
                 <Button x:Name="BRefresh" Style="{StaticResource HeaderBtn}" Margin="0,0,5,0" ToolTip="Re-Scan"><Viewbox Width="20" Height="20"><Path Fill="#4CAF50" Data="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></Viewbox></Button>
...
$Stack = $Window.FindName("List"); $BA = $Window.FindName("BA"); $BC = $Window.FindName("BC"); $BF = $Window.FindName("BF"); $BG = $Window.FindName("BG"); $BAbt = $Window.FindName("BAbt"); $BRefresh = $Window.FindName("BRefresh")
...
$BRefresh.Add_Click({ Load-BrowserList; Play-Sound "Click" })

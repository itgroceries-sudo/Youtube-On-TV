...
# =========================================================
#  YOUTUBE TV INSTALLER v75.5.2 (VECTOR REFRESH)
#  File: 7552.ps1 | Branch: branch
#  Status: Vector Style Refresh | Stable Refresh | Log Fix
# =========================================================
...
$TempScript = "$env:TEMP\7552.ps1"
# [FIX] Pointing to 'branch' and '7552.ps1'
$GitHubRaw = "https://raw.githubusercontent.com/itgroceries-sudo/Youtube-On-TV/branch"
$SelfURL = "$GitHubRaw/7552.ps1"
$AppVersion = "2.0 Build 23.75.5.2"
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="0"><Grid.ColumnDefinitions><ColumnDefinition Width="Auto"/><ColumnDefinition Width="*"/></Grid.ColumnDefinitions>
            ...
            <StackPanel Grid.Column="1" Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Top" Margin="0,5,0,0">
                <Button x:Name="BRefresh" Style="{StaticResource VectorBtn}" Margin="0,0,5,0" ToolTip="Re-Scan Browsers">
                    <Viewbox Width="20" Height="20"><Path Fill="#AAAAAA" Data="M17.65,6.35C16.2,4.9,14.21,4,12,4A8,8,0,0,0,4,12A8,8,0,0,0,12,20C15.73,20,18.84,17.45,19.73,14H17.65C16.83,16.33,14.61,18,12,18A6,6,0,0,1,6,12A6,6,0,0,1,12,6C13.66,6,15.14,6.69,16.22,1.78L13,11H20V4L17.65,6.35Z"/></Viewbox>
                </Button>
...
Write-Log "------------------------------------------"
Write-Log "   (V.2 Build 23.75.5 : $BuildDate)"
Write-Log "------------------------------------------"

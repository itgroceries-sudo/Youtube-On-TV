...
# =========================================================
#  YOUTUBE TV INSTALLER v75.7.3 (FINAL EXPANSION)
#  Version: 2.0 Build 23.75.7.3
#  File: 7573.ps1 | Branch: branch
#  Status: Big UI | PC Naming Fix | No Kill on PC | Silent Fix
# =========================================================

# ---------------------------------------------------------
# [1] CONFIGURATION
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.7.3"
...
for ($i = 0; $i -lt $AllArgs.Count; $i++) {
    if ($AllArgs[$i] -eq "-Silent") { 
        $Silent = $true; 
        $AddStartMenu = $true # [FIX 4] Force StartMenu in Silent Mode
    }
...
function Install-Browser {
    ...
    foreach ($TargetDir in $Targets) {
        ...
        $s.WindowStyle = 3; $s.Description = $Desc; if(Test-Path $LocalIcon){ $s.IconLocation = $LocalIcon }
        $s.Save()
    }
...
Title="YouTube TV Installer" Height="$BaseH" Width="$BaseW" WindowStartupLocation="Manual" ResizeMode="NoResize" Background="#181818" Topmost="false" WindowStyle="None" BorderBrush="#2196F3" BorderThickness="4">
    <Window.Resources>
            ...
            <StackPanel Orientation="Horizontal" Grid.Column="0">
                <Button x:Name="BDesk" Style="{StaticResource LabeledBtn}" ToolTip="Toggle Desktop Shortcut" Tag="On" Background="#0078D7">
                    <StackPanel Orientation="Horizontal">
                        <Viewbox Width="26" Height="26" Margin="0,0,8,0"><Path Fill="White" Data="M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z"/></Viewbox>
                ...
                <Button x:Name="BWin" Style="{StaticResource LabeledBtn}" ToolTip="Toggle Start Menu Shortcut" Tag="Off">
                    <StackPanel Orientation="Horizontal">
                        <Viewbox Width="26" Height="26" Margin="0,0,8,0"><Path Fill="White" Data="M0 0h11.377v11.372H0V0zm12.623 0H24v11.372H12.623V0zM0 12.623h11.377V24H0V12.623zm12.623 0H24V24H12.623V12.623z"/></Viewbox>
                ...
                <Button x:Name="BTrash" Style="{StaticResource LabeledBtn}" ToolTip="Toggle Uninstall Mode" Tag="Off">
                    <StackPanel Orientation="Horizontal">
                        <Viewbox Width="24" Height="24" Margin="0,0,8,0"><Path Fill="White" Data="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></Viewbox>
        ...
        <Grid Grid.Row="4">
            ...
            <StackPanel Orientation="Horizontal" Grid.Column="0">
                 <Button x:Name="BF" Style="{StaticResource LabeledBtn}" ToolTip="Visit Facebook">
                    <StackPanel Orientation="Horizontal">
                        <TextBlock Text="f" Foreground="#1877F2" FontSize="28" FontWeight="Bold" Margin="0,-4,8,0" VerticalAlignment="Center"/>

...
# =========================================================
#  YOUTUBE TV INSTALLER v90.0 (SILENT PRECISION)
#  Status: Silent Logic Fixed | Respects -Browser Argument
# =========================================================
...
$SelfURL = "$GitHubRaw/90.ps1"
$AppVersion = "2.0 Build 32.90"
...
function Install-Logic($BrowserName) {
    ...
    # Match logic: Name or Key must match the input argument
    $Obj = $Browsers | Where-Object { $_.N -match $BrowserName -or $_.K -match $BrowserName }

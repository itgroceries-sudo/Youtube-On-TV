...
<div align="center">
    <img src="https://github.com/user-attachments/assets/8bae844c-b3a5-4258-8c02-baf86c439366" width="100%" style="display: block; margin: 0 auto;">
  </a>
</div>
</details>
---

## 🚀 ปล่อยอัปเดต v2.0 Build 23.75.6.6 (Ultimate Edition)

**มีอะไรใหม่:**
* 🎨 **ดีไซน์ UI ใหม่:** เปลี่ยนใช้ไอคอนแบบ Vector ทันสมัย, มาพร้อม Dark Theme และการจัดวางแบบ Card ที่สวยงาม
* 🖱️ **ประสบการณ์ใช้งาน (UX) ที่ดีขึ้น:** เพิ่มเสียงประกอบตอบโต้การใช้งาน (เสียงคลิก, ติ๊กถูก, แจ้งเตือน, และทำงานเสร็จสิ้น)
* ⚙️ **ตัวเลือกการควบคุมเต็มรูปแบบ (Full Control):**
    * สลับโหมดถอนการติดตั้ง (ไอคอนถังขยะ)
    * เลือกสร้าง Shortcut ใน Start Menu (ไอคอน Windows)
    * เลือกสร้าง Shortcut บน Desktop (ไอคอน Desktop) - *ของใหม่!*
* 🖥️ **อัปเกรดระบบ Console:** ปรับปรุงหน้าต่าง Console แบบไม่มีปุ่มปิด (No-Close) ให้ทำงานเสถียรยิ่งขึ้น
* 🐞 **แก้ไขข้อผิดพลาด (Bug Fixes):** แก้ปัญหาโปรแกรมปิดตัวเองขณะขอสิทธิ์ Admin และเพิ่มการแจ้งเตือนกรณีหาไฟล์ที่จะถอนการติดตั้งไม่เจอ
...
![Installer GUI](https://github.com/user-attachments/assets/95a14f34-5631-45f8-a949-fa57bbe0b101)
...
<details>
  <summary>### คลิกเพื่อดูรูปภาพ</summary>
<div align="center">
  <img src="https://github.com/user-attachments/assets/32e09221-3fd7-4a68-8bc6-e98127b317ca" width="100%" style="display: block; margin: 0 auto;">
  </a>
</div>
</details>

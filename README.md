...
* **Universal TV Mode:** 🌍 ใช้มาตรฐาน User-Agent ใหม่ (**Samsung Tizen 7.0**) รองรับทั้ง **Brave**, **Chrome** และ **Edge** อย่างสมบูรณ์แบบ
* **Universal Auto-Kill:** ⚔️ **ใหม่!** ทุก Shortcut จะฝังคำสั่ง **"ปิด Browser ตัวเก่า"** (Force Close) ก่อนเปิดใหม่เสมอ การันตีว่า TV Mode จะทำงานได้ 100% ไม่ว่าคุณจะเปิดแท็บอะไรค้างไว้ก็ตาม
* **Custom Icon Injection:** 🎨 ดึงไอคอน YouTube สวยๆ จาก Server มาใช้โดยตรง (ไม่ต้องทนใช้รูปไอคอนกระดาษหรือรูป Browser)

...
# =========================================================
#  YOUTUBE TV INSTALLER v75.5 (REFRESH ADDED)
#  Status: Added Live Refresh Button | Re-Scan Logic
# =========================================================
...
if(!$Silent){ 
    ...
    Write-Host "   (V.2 Build 23.75.5 : $BuildDate)       " -ForegroundColor Green
...
Title="YouTube TV Installer" Height="$BaseH" Width="$BaseW" WindowStartupLocation="Manual" ResizeMode="NoResize" Background="#181818" Topmost="True">
    ...
    <Grid Margin="25">
        ...
        <Grid Grid.Row="0"><Grid.ColumnDefinitions><ColumnDefinition Width="Auto"/><ColumnDefinition Width="*"/></Grid.ColumnDefinitions>
            ...
            <StackPanel Grid.Column="1" Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Top" Margin="0,5,0,0">
                <Button x:Name="BRefresh" Width="30" Height="30" Background="Transparent" BorderThickness="0" Cursor="Hand" Margin="0,0,5,0" ToolTip="Re-Scan Browsers">
                    <Viewbox Width="20" Height="20">
                        <Path Fill="#AAAAAA" Data="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/>
                    </Viewbox>
                </Button>
                <Button x:Name="BAbt" Width="30" Height="30" Background="Transparent" BorderThickness="0" Cursor="Hand" ToolTip="About">
                    <Viewbox Width="20" Height="20">
...
$BRefresh.Add_Click({ 
    Load-BrowserList 
    [System.Console]::Beep(1500, 100) # Little feedback beep
})

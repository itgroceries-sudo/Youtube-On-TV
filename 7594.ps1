...
# =========================================================
#  YOUTUBE TV INSTALLER v75.9.4 (ROBUST & FAST)
#  Version: 2.0 Build 23.75.9.4
#  File: 7594.ps1
#  Status: .NET BOM Fix | No Re-Scan | Layout Final
# =========================================================

# ---------------------------------------------------------
# [1] CONFIG & LANGUAGE
# ---------------------------------------------------------
$AppVersion = "2.0 Build 23.75.9.4"
...
if (-not $Silent -and -not $IsAdmin) {
    ...
    try {
        if ($TargetFile -and (Test-Path $TargetFile)) {
            ...
            # [FIX] Use .NET to force UTF-8 with BOM (Works on all PS versions)
            $WebClient = New-Object System.Net.WebClient
            $WebClient.Encoding = [System.Text.Encoding]::UTF8
            $ScriptContent = $WebClient.DownloadString($SelfURL)
            
            # Universal BOM writing
...
if(!$Silent){ Write-Host "`n==========================================" -ForegroundColor Green; Write-Host "   (V.2 Build 23.75.9.4 : $BuildDate)     " -ForegroundColor Green; Write-Host "==========================================" -ForegroundColor Green; Write-Host " [INIT] Scanning installed browsers..." -ForegroundColor Green }
...
# [OPTIMIZATION] Separate Scan from Render
...
"@
    ...
    # [OPTIMIZATION] Render ONLY (No scanning)
    function Render-BrowserList {
        ...
        foreach ($b in $Global:Browsers) {
            ...
            if ($b.IsFound) { if(!$Silent){ Write-Host " [RENDER]  $($b.N)" -ForegroundColor Green } } 

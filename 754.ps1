...
# =========================================================
#  YOUTUBE TV INSTALLER v75.4 (LOG FEEDBACK FIX)
#  Status: Internal Console Logs Actions | Admin Required
# =========================================================
...
# XAML (Internal Console + Blue Border)
[xml]$xaml = @"
...
Write-Log "------------------------------------------"
Write-Log "   (V.2 Build 23.75.4 : $BuildDate)"
Write-Log "------------------------------------------"

...
# =========================================================
#  YOUTUBE TV INSTALLER v75.5.3 (VECTOR REFRESH REFINED)
#  File: 7553.ps1 | Branch: branch
#  Status: Vector UI | Live Refresh | Stable Core
# =========================================================
...
$TempScript = "$env:TEMP\7553.ps1"
# [FIX] Pointing to 'branch' and '7553.ps1'
$GitHubRaw = "https://raw.githubusercontent.com/itgroceries-sudo/Youtube-On-TV/branch"
$SelfURL = "$GitHubRaw/7553.ps1"
$AppVersion = "2.0 Build 23.75.5.3"
...
Write-Log "------------------------------------------"
Write-Log "   (V.2 Build 23.75.5.3 : $BuildDate)"
Write-Log "------------------------------------------"

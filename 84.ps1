...
# =========================================================
#  YOUTUBE TV INSTALLER v84.0 (INTERNAL CONSOLE)
#  Status: All-in-One UI | No External Console | Persistent
# =========================================================
...
$SelfURL = "$GitHubRaw/84.ps1"
$AppVersion = "2.0 Build 28.84"
$BuildDate  = "30-1-2026"
    ...
    <Grid Margin="25">
        ...
        <Border Grid.Row="3" Background="#000000" CornerRadius="8" Margin="0,15,0,0" BorderBrush="#333333" BorderThickness="1">
            <ScrollViewer x:Name="LogScroll" VerticalScrollBarVisibility="Auto">
                <TextBlock x:Name="LogBox" Foreground="#00FF00" FontFamily="Consolas" FontSize="11" Margin="10" TextWrapping="Wrap" Text="[INIT] System Ready..."/>
            </ScrollViewer>
        </Border>
